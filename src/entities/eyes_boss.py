...
from config import Color, EyesBossConfig
...
class EyesBoss(Shadow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.initial_hp = EyesBossConfig.INITIAL_HP
    ...
    def _update_action(self):
        if self.set_action(
            ActionType.ANGRY,
            duration_ms=EyesBossConfig.ANGRY_DURATION_MS,
            interval_ms=EyesBossConfig.ANGRY_INTERVAL_MS,
        ):
            self._get_angry()
    ...
    def _take_damage(self, damage: int):
        self.hp -= damage
        self.start_hurt(duration_ms=EyesBossConfig.HURT_DURATION_MS)
